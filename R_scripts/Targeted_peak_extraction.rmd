...
path_data_in <- "T:/shares/di04_limet_bioinformatics/PhD Pablo/Scripts/SCRIPT FOR TARGETED EXTRACTION HERE/Tutorial_example/Example files/" 
#here you should enter the path to your spreadsheet (.xlsx) with targeted compounds
masslist <- read_excel("T:/shares/di04_limet_bioinformatics/PhD Pablo/Publicaties/WIP/Gut Phenotyping/Database/Database_fecal_metabolomics.xlsx")
